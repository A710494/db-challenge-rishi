...
public class AccountsController {
    ...
    public ResponseEntity<Object> createAccount(@RequestBody @Valid Account account) {
        ...
        return new ResponseEntity<>("Account " + account.getAccountId() + " created for the customer", HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<Object> amountTransfer(@RequestBody @Valid AmountTransfer amountTransfer) {
        log.info("Server has received a request to transfer funds between account");
        ...
        log.info("Transaction has been performed successfully");
